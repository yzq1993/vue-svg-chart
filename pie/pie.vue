  ...
  computed:{
    ...
    pathList:function(){
      ...
      return this.list.map(v=>{
        ...
        cmd=this.setD({rotation:rotation,startAngle:startAngle,endAngle:endAngle,percent:percent,radius:radius})
        startAngle=endAngle
        return {
          ...v,
          d:cmd,
  ...
  methods:{
    ...
    setD(obj){
      let tmp=[
        ...
        'L',this.center.x+Math.cos(obj.startAngle)*obj.radius,this.center.y+Math.sin(obj.startAngle)*obj.radius,
